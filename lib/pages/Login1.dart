    ...
    return MaterialButton(
      ...
      child: Column(
        children: <Widget>[
          ...
          const Text("Iniciar Sesion con Facebook",
              textAlign: TextAlign.left,
              style: TextStyle(
                  fontFamily: 'Poppins', color: Colors.white)), // text
        ],
      ),
      shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(10.0),
    ...
    return MaterialButton(
      ...
      child: Column(
        children: <Widget>[
          ...
          const Text("Iniciar Sesion con Huella",
              style: TextStyle(color: Color(0xff826AD9))), // text
        ],
      ),
      shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(10.0),
    ...
    return Container(
        ...
        child: Stack(children: <Widget>[
          Positioned(
              ...
              left: 0,
              child: Divider(
                  color: Color.fromRGBO(199, 201, 217, 1), thickness: 1)),
          Positioned(
              top: 14,
              left: 213,
              child: Divider(
                  color: Color.fromRGBO(199, 201, 217, 1), thickness: 1)),
          Divider(color: Color.fromRGBO(199, 201, 217, 1), thickness: 1),
          Positioned(
              top: 0,
              left: 177,
              child: Text(
